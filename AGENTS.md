...
## Repository Overview
This is a markdown-based workflow system with 5 sequential development phases: Concept → Requirements → Design → Tasks → Implementation.
...
- Phase files: `<phase>-<description>.md` (numbered phases 01-05)
- Supporting tools: `doc-generator.md`, `workflow.md`, `workflow-guide.md`
